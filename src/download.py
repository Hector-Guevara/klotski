...
Pot descarregar-ne tots els puzzles de cop, o descarregar-ne un en concret si es dona la direcció
...
import json
import os
import sys  # Afegit per poder llegir els arguments de la terminal
...
def get_json(url):
    """
    Functió per obtenir l'arxiu JSON d'un enllaç donat.
    """
...
def download_one(puzzle_id: str) -> None:
    ...
    El guarda a la carpeta DEST_FOLDER amb el nom del seu ID.
    """
